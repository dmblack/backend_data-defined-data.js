...
function readWhereIDEq (id) {
  if (typeof id === 'number') {
    ...
    return Promise.reject('FAIL: Cannot lookup ID with variable type: \'' + typeof (id) + '\'. Type: \'number\' is required.');
  }
}
...
function readColumnWhereIDEq (column, id) {
  if (typeof column === 'string' && typeof id === 'number') {
    ...
    return Promise.reject('FAIL: Cannot lookup \'' + column + '\' with variable type: \'' + typeof (id) + '\'. Type: \'number\' is required.');
  }
}
...
function readColumnWhereColumnEq (getColumn, whereColumn, value) {
  if (typeof getColumn === 'string' && typeof whereColumn === 'string' && typeof value === 'string') {
    ...
    return Promise.reject('FAIL: Cannot get \'' + getColumn + '\' with lookup \'' + whereColumn + '\' where value type: \'' + value + '\'.');
  }
}
